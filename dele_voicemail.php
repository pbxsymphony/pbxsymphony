    ...
    <div class="well" >
    	<?php
          ...
          include("database.php");
            ...
            mysql_close();
	     ?>
		<H2><span class="label label-info">Eliminar Queue Member</span></H2>
        <form class="form-horizontal" action="save_delevoicemail.php" method="post" >
        <fieldset >
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <button id="Submit" name="Submit" type="submit" class="btn btn-success">Eliminar</button>

...
<body>
    ...
    <div class="well" >
        ...
        <form class="form-horizontal" action="save_delemember.php" method="post" >
        <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            ...
            <button id="Reset" name="Reset" type="reset" class="btn btn-success" onclick="location.href='index-sip-queues-agent.php'" >Back</button>
          </div>
        </div>

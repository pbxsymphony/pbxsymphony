    ...
    <div class="container">
      ...
      $lista = "SELECT * FROM queue_table WHERE id='$id'";
          ...
          $observation=$row['observation'];
			...
			mysql_close();
	  ?>
		<H2><span class="label label-info">Eliminar Queue</span></H2>
        <form class="form-horizontal" action="save_dele_queues_table.php" method="post" >
        <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-2">
          <input id="id" name="id" type="text" placeholder="" class="form-control input-md" value="<?php  echo $id; ?>" readonly>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            ...
            <button id="Reset" name="Reset" type="reset" class="btn btn-success" onclick="location.href='index-sip-queues.php'" >Cancelar</button>
          </div>
        </div>

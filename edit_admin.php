...
<body role="document">
  ...
  ?>
    ...
    <div class="well" >
      ...
      $lista = "SELECT * FROM users WHERE users_id='$users_id' limit 1";
	    ...
	    ?>
		  <H2><span class="label label-info">Modificar Admin</span></H2>
      
      <form class="form-horizontal" action="save_editadmin.php" method="post" >

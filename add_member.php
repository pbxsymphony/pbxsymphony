...
<body>
    ...
    <H2><span class="label label-info"> Add Queue Member</span></H2>
        <form class="form-horizontal" action="save_member.php" method="post" >
         <!-- Text input-->
        <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input id="membername" name="membername" type="text" placeholder="membername " readonly value="<?php echo $_SESSION["k_membername"]; ?>" class="form-control input-md">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input id="interface" name="interface" type="text" placeholder="interface " readonly value="SIP/<?php echo $_SESSION["k_extension"]; ?>" class="form-control input-md">
          <span class="help-block"> Ejemplo: 1000 </span>
          </div>
        </div>
        </fieldset>
